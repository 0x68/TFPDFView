...
var kDefaultURL = 'data/compressed.tracemonkey-pldi-09.pdf';
...
function getMyPdfFromUrl(arg) {
  PDFView.initialize();
  PDFView.open(arg, 0);
}

function getMyPdfFromData(arg){
  PDFView.initialize(); 
  var byteArray = Base64Binary.decodeArrayBuffer(arg);  
  PDFView.load(byteArray, 0);
  console.log(arg.length);
}

//Sketchy One Working on it 
//Try to empty the view
function clear(){
